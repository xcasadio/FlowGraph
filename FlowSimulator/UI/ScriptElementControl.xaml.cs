...
namespace FlowSimulator.UI
{
    ...
    public partial class ScriptElementControl : UserControl
    {
        ...
        public ScriptElementControl()
        {
            ...
            //textEditor.TextArea.DefaultInputHandler.NestedInputHandlers.Add(new SearchInputHandler(textEditor.TextArea, textEditor.searc));
        }
